...
export function FoundationReviewChecks({ artifact }: { artifact: FoundationBuildArtifactV1 | FoundationProtocolBuildV1 }) {
  if (artifact.schemaVersion === "programmable.modules.foundation-protocol-build.v1") return <div className={styles.testTable}><table>
