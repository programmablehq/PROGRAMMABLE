  ...
  return <div className={styles.page}>
    ...
    <div className={styles.marketLayout}>
      <div className={styles.mainColumn}>
        <RobinhoodChart poolId={pool.poolId} name={coin.name} />
      ...
      <div className={styles.marketAbout}><p>{coin.description}</p><dl className={styles.rows}><div><dt>Coin address</dt><dd><FoundationAddress value={coin.address} label="coin address" /></dd></div></dl><FoundationPoolDetails pool={pool} positions={positions} />
