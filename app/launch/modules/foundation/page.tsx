...
export const metadata: Metadata = { title: "Create a coin · Programmable", description: "Create a fixed-supply coin with a Uniswap v4 pool and optional reviewed modules." };
