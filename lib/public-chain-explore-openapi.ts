...
const page = object({ number: { type: "integer", minimum: 1 }, size: { enum: [6, 8, 10, 50] },
...
const parameters = (chain: "ethereum" | "robinhood") => [
  ...
  { name: "pageSize", in: "query", schema: { type: "integer", enum: [6, 8, 10, 50], default: chain === "ethereum" ? 10 : 50 } },
