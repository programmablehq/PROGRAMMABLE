...
contract FoundationNativeV2Test is FoundationForkBaseV2 {
    ...
    function test_fixedInfinitePermit2QuoteNeedsNoExplicitTokenApproval() public {
        quote = new FoundationFixedPermit2QuoteFixture();
    ...
    function testFuzz_nativeFundingAndRefundNeverTouchWalletWeth(uint96 buySeed, uint96 excessSeed) public {
        ...
        uint256 beforeEth = ALICE.balance;
        vm.prank(ALICE);
        L.LaunchResultV2 memory r = nativeFactory.launchWithEthRoute{ value: buy + excess }(p, _emptyPath());
...
contract FoundationFixedPermit2QuoteFixture is FoundationQuoteFixture {
