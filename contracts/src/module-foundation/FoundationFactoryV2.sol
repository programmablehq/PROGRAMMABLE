...
interface IFoundationUniversalRouterV2 {
    function execute(bytes calldata commands, bytes[] calldata inputs, uint256 deadline) external payable;
    function poolManager() external view returns (IPoolManager);
}

interface IFoundationPositionPermit2V2 {
...
contract FoundationFactoryV2 is ReentrancyGuardTransient {
    using SafeERC20 for IERC20;
    using PoolIdLibrary for PoolKey;
    bytes32 public constant VERSION_ID = keccak256("programmable.module-foundation.factory.v2");
